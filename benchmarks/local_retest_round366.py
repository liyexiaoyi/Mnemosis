"""Round-366 local-model re-test: same chaos contexts, local answer models.

Answers the round-366 chaos spot-check questions from the exact contexts
...
def main() -> int:
    ...
    out = os.path.join(_WORK, f"{domain}_local_round366.json")
