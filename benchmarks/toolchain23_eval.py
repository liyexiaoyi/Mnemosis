"""Toolchain panorama 23 (round 216).

Extends the 75-step run with test_generator, spacing_plan and
rumination_check (78 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain23_eval.json"),
    )
