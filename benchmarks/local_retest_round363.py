"""Round-363 local-model re-test: same contexts, local answer models."""
...
def main() -> int:
    domain = sys.argv[1] if len(sys.argv) > 1 else "basketball"
    ...
    out = os.path.join(_WORK, f"{domain}_local_round363.json")
