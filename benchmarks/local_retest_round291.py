"""Round-291 local-model re-test: same contexts, local answer models."""
...
from class_spot_bench import QUESTIONS  # noqa: E402
...
def main() -> int:
    ...
    for model in MODELS:
        ...
        with open(
            os.path.join(_WORK, f"class_local_{model.replace(':', '_')}.json"),
            "w",
            encoding="utf-8",
        ) as handle:
