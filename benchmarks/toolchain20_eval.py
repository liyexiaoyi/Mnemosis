"""Toolchain panorama 20 (round 202).

Extends the 67-step run with emotion_advice, difficulty_estimator and
memory_integration (70 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain20_eval.json"),
    )
