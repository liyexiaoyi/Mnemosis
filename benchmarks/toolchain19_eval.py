"""Toolchain panorama 19 (round 197).

Extends the 64-step run with recall_trace, community_report and
sleep_advice (67 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain19_eval.json"),
    )
