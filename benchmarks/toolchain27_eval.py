"""Toolchain panorama 27 (round 236).

Extends the 87-step run with cue_diversity, weekly_review and
transfer_prompt (90 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain27_eval.json"),
    )
