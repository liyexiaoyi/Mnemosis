"""Toolchain panorama 22 (round 211).

Extends the 72-step run with sleep_inference, schema_fit and
working_set_budget (75 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain22_eval.json"),
    )
