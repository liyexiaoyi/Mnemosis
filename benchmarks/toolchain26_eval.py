"""Toolchain panorama 26 (round 231).

Extends the 84-step run with analogy_bridge, next_interval and
nightly_routine (87 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain26_eval.json"),
    )
