"""Toolchain panorama 24 (round 221).

Extends the 78-step run with consolidation_forecast, forgetting_balance
and metacog_report (81 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain24_eval.json"),
    )
