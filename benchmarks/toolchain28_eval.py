"""Toolchain panorama 28 (round 241).

Extends the 90-step run with curve_fit, affect_decay and goal_progress
(93 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain28_eval.json"),
    )
