"""Toolchain panorama 25 (round 226).

Extends the 81-step run with reconsolidation_plan, mastery_map and
attention_filter (84 steps).
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default=os.path.join(_BENCH, "results", "toolchain25_eval.json"),
    )
