...
详细配置见 [`docs/mcp-quickstart.md`](docs/mcp-quickstart.md)。
...
- [`docs/memory-model.md`](docs/memory-model.md)：人脑记忆原理 ↔ 项目机制对照表
- [`docs/storage-guide.zh-CN.md`](docs/storage-guide.zh-CN.md)：存储功能介绍（技术人员版）
- [`docs/architecture.md`](docs/architecture.md)：模块与数据流
- [`docs/research.md`](docs/research.md)：每一篇论文/文献依据
- [`docs/mcp-quickstart.md`](docs/mcp-quickstart.md)：各客户端接入配置
